...
import (
	...
	"github.com/didactiklabs/vault-unseal-controller/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "150b2206.didactiklabs.io",
	...
	if err = (&controller.UnsealReconciler{
		Client:        mgr.GetClient(),
		Scheme:        mgr.GetScheme(),
		UnsealerImage: unsealerImage,
