...
KIND_CLUSTER ?= vault-unseal-controller-test-e2e
...
.PHONY: build-unsealer
build-unsealer: ## Build vault-unsealer binary.
	cd vault-unsealer && go build -o ../bin/vault-unsealer main.go
